<%-- 
    Document   : ListadoPresupuesto
    Created on : 13/11/2021, 10:52:36
    Author     : carme
--%>
    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5 pt-5">
                ...
                <h3 class="d-flex justify-content-center">Listado de presupuestos</h3>
                <div class="table-wrapper-scroll-y my-custom-scrollbar">
                    <table class="table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th>Monto a facturar por Obra Social</th>
                        ...
                        <c:forEach items="${requestScope.lst}" var="r">
                            <tr>
                                <td>${r.idPresupuesto}</td>
                                <td>${r.idReceta}</td>
                                <td>${r.fecha}</td>
                                <td>${r.montoTotal}</td>
                                <td>${r.montoFacturar}</td>
                    ...
                    <div class="container ">
                          <a class =" btn btn-primary" href = "ListadoRecetas" style="margin-top: 20px; width: 300px ; margin-left: 300px">
                              <span class="  mr-3 fa fa-chevron-left  "> </span> Listado de recetas</a>
                    </div>
