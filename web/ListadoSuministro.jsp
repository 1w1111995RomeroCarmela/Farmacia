<%-- 
    Document   : ListadoSuministro
    Created on : 31/10/2021, 16:46:06
    Author     : carme
--%>
    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5 pt-5">
                ...
                <h3 class="d-flex justify-content-center">Listado de Productos</h3>
