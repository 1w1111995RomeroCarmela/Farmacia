<%-- 
    Document   : ReporteRecetaPorSucursal
    Created on : 01/11/2021, 22:09:20
    Author     : carme
--%>
                ...
                <div class="table-wrapper-scroll-y my-custom-scrollbar">
                    <table class="table ">
                        ...
                        <c:forEach items="${requestScope.lst}" var="c">
                            <tr>
                                <td>${c.nombre}</td>
                                <td>${c.cantidadRecetas}</td>
                                <td>${c.montoObrasSociales}</td>
                                <td>${c.montoCliente}</td>
                                <td>${c.sucursal}</td>
