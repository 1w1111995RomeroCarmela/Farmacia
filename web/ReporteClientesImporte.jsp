<%-- 
    Document   : ReporteClientesImporte
    Created on : 01/11/2021, 16:35:02
    Author     : carme
--%>
    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5 pt-5">
                ...
                <h3 class="d-flex justify-content-center">Listado de clientes ordenado por importe total presupuestado.</h3>
                <div class="table-wrapper-scroll-y my-custom-scrollbar">
                    <table class="table">
                        <thead class="thead-light">
                            <tr>
                                <th>Nombre del cliente</th>
                                <th>Monto total presupuestado</th>
