<%-- 
    Document   : ComboProfesionales
    Created on : 01/11/2021, 18:10:09
    Author     : carme
--%>
    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5 pt-5">
                <h2 class="mb-4 d-flex justify-content-center">Consultar recetas </h2>


                <form action="ReporteRecetasProfesional" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 ">
                                ...
                                <label for="cboProfesionales">Seleccione un profesional</label>
                            ...
                            <div class="col-sm-12 "> 
                                ...
                                <label class=""></label>
                                <button type="submit" class="form-control btn btn-primary btn-block" value="Consultar">
                                    Consultar
                                </button>
                            </div>
                        </div>    
