<%-- 
    Document   : ReporteCantidadRecetas
    Created on : 01/11/2021, 20:02:23
    Author     : carme
--%>
    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5 pt-5">
                ...
                <h3 class="d-flex justify-content-center">Listado de profesionales ordenado por cantidad de recetas.</h3>
