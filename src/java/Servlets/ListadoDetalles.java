 ...
 * @author carme
 */
@WebServlet(name = "ListadoDetalles", urlPatterns = {"/ListadoDetalles"})
public class ListadoDetalles extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<DTODetalle> lista = controller.obtenerDetalle(id);        
        request.setAttribute("lst", lista);
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ListadoDetalle.jsp");
